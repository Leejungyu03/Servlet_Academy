...
<div id="wrap" class="container text-center">
		...
		<nav class="menu bg-danger">
			<ul class="nav nav-fill w-100">
				...
				<li class="nav-item"><a class="nav-link text-white" href="?pageChange=terrestrial.jsp">지상파</a></li>
				<li class="nav-item"><a class="nav-link text-white" href="#">드라마</a></li>
				<li class="nav-item"><a class="nav-link text-white" href="#">메뉴</a></li>
		...
		<footer>
			<div class="mt-3">Copyright 2021. marondal All Rights Reserved </div>
		</footer>
	</div>
</body>
</html>